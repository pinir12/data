...
export default function UserDisplay({ setShowUserDisplay }) {
  ...
  const handleCheckboxChange = () => {
    ...
    return (
        ...
        <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-20 backdrop-brightness-50" onClick={() => setShowUserDisplay(false)}>
                    ...
                    {userRole && userRole === 'admin' ?
                        <div className="text-gray-900 bg-white">
                            <div className="px-4 py-2 flex justify-between">
                                ...
                                <span onClick={() => setShowUserDisplay(false)} className="text-2xl cursor-pointer">
