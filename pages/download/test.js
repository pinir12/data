...
<>
            <Head>
                <title>download.PiniR</title>
            </Head>
            
            <div className="w-full min-h-screen bg-[#FDFDFD] text-slate-900 font-sans antialiased">
                
                {/* --- COMPACT TOP BAR --- */}
                <nav className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between border-b border-slate-100">
                ...
                download<span className="font-light text-indigo-300">.PiniR</span>
                    ...
                    <div className="flex items-center gap-4 text-slate-400">
                        ...
                        <button onClick={() => signOut()} className="text-[10px] font-bold hover:text-red-500 transition-colors uppercase">
                            Sign Out
                        </button>
                    </div>
                </nav>
